            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                        this.reply(m.chat, `Limit anda habis, Silahkan upgrade ke premium user untuk mendapatkan unlimited limit, Hub: wa.me/6285893892553, price? 10k :>`, m)
   ...
   async participantsUpdate({ id, participants, action }) {
		...
		case 'invite_v4':
			    ...
			    mentionedJid: [user],
                            ...
                            body: global.wm,
                            thumbnailUrl: pp,
                            sourceUrl: 'https://whatsapp.com/channel/0029VaeoO0cJUM2amRmTFB1a',
                            mediaType: 1,
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        premium: 'Perintah ini hanya untuk member *premium*, Silahkan upgrade ke premium user untuk menggunakan fitur ini, Cuman 10k :>, Minat hub: wa.me/6285893892553',
